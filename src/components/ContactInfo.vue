<template>
  <section ref="sectionRef" class="contact fade-in-section">
    ...
    <div class="contact-links">
      <a href="https://www.linkedin.com/in/matisse-ben-addi-8b88a7333" target="_blank" class="contact-btn linkedin">
      ...
      <a href="https://github.com/Matisse2k" target="_blank" class="contact-btn github">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a href="mailto:matisse.lyes@gmail.com" class="contact-btn email">
